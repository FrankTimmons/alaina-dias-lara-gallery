  ...
  return (
    <div className='fixed left-0 right-0 top-0 bottom-0 w-full h-full flex items-center justify-center z-30 bg-black/90'>
      ...
      <div className='w-[90%] h-[90%] flex justify-center'>
        <img className='object-contain' src={urlFor(galleryPaintings[currentPainting].image)} alt="" />
      </div>
      <div className='fixed right-0 w-[50%] h-full' onClick={currentPainting == (galleryPaintings.length - 1) ? null : nextPainting}>
